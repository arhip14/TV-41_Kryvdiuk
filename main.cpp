/* ----------------------------------------------------------------<Header>-
 ...
 Група:                 ТВ-41
 Студент:               Кривдюк А.В.
 Дата створення:        2025-04-10
 Останнє редагування:   2025-05-13
 Опис:
 ...
 /* ---------------------------------------------------------------------[<]-
  ...
  ---------------------------------------------------------------------[>]-*/
    ...
    /* ---------------------------------------------------------------------[<]-
       Виводить рішення у файл (без кольорового форматування).
    ---------------------------------------------------------------------[>]-*/
 ...
 /* ---------------------------------------------------------------------[<]-
  ...
  /* ---------------------------------------------------------------------[<]-
       Ініціалізує початкове поле та генерує всі можливі доміно.
    ---------------------------------------------------------------------[>]-*/
...
/* ---------------------------------------------------------------------[<]-
     Точка входу в програму. Організовує меню, введення та запуск розв’язання.
---------------------------------------------------------------------[>]-*/
int main() {
     printHeader();
     cin.ignore();
